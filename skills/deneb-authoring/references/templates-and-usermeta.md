...
Purpose: Reusable template authoring and Deneb template metadata structure.
...
Source URL: https://deneb.guide/docs/templates

Deneb has a number of built-in templates that are available from the **Create New Specification** dialog. This is demonstrated in the [Simple Worked Example](/docs/simple-example#selecting-the-template) when we create our first chart.
...
[https://deneb-viz.github.io/schema/deneb-template-usermeta-v1.json](https://deneb-viz.github.io/schema/deneb-template-usermeta-v1.json)
