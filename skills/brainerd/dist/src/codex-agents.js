...
export const renderCodexAgentsBlock = () => [
    ...
    "the generated entrypoints themselves. Use the installed `brainerd` skill",
    "for setup, reflection, and rumination writes. In Pi, keep using the native",
    "`/pi-init`, `/pi-reflect`, and `/pi-ruminate` surfaces. Do not perform",
