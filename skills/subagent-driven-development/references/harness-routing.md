...
In Anthropic-style setups, map the flagship reasoning model to controller, the midsize coding model to implementer, the most reliable diff reader to reviewer, and the cheapest fast model to explorer.

In Gemini-style setups, map the Pro or flagship class to controller, the Flash or balanced class to implementer, the most reliable diff reader to reviewer, and the cheapest fast reader to explorer.
...
- Never assume Spark exists outside Codex or all OpenAI surfaces.
